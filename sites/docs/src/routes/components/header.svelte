	...
	<div class="container mx-auto px-4">
		<div class="flex h-16 items-center justify-between">
			...
			<nav class="hidden md:flex items-center gap-4">
				...
				<a href="/examples" class="text-sm font-medium hover:text-primary transition-colors">
					Examples
				</a>
				<Button variant="ghost" size="icon" href="https://github.com/geodask/svelte-reactive-table">
					<Github />
				</Button>
				<Button size="icon" variant="ghost" onclick={toggleMode}>
					{#if mode.current === 'dark'}
